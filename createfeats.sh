...
cd ../..
python scripts/utils/compact_flows.py csv/base-datasets/cicfl_used_format/*.csv csv/selected-compacted-datasets/${1}features/raw/Malign-Dataset.csv -f${1} --csv
python scripts/utils/compact_flows.py csv/base-datasets/cicfl_used_format/*.csv csv/selected-compacted-datasets/${1}features/raw/benign/Benign-Dataset.csv -f${1} --csv --benign
