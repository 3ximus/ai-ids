...
python scripts/data_selector.py csv/train/extracted/pscan/*.csv csv/train/extracted/dos/*.csv csv/train/extracted/bruteforce/*.csv "${NN1_TRAIN_DIR}/individual/" -r
