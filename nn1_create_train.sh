...
python scripts/data_selector.py ${NN1_EXTRACTED_TRAIN}/portscan/*.csv ${NN1_EXTRACTED_TRAIN}/fastdos/*.csv ${NN1_EXTRACTED_TRAIN}/slowdos/*.csv ${NN1_EXTRACTED_TRAIN}/bruteforce/*.csv "${NN1_TRAIN_DIR}/individual/" -r
